...
export const configSchema = z.object({
  ...
  EVENTS: z.object({
    SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_COMPLETE_NAME: z.string(),
    SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_COMPLETE_URL: z.string(),
    SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_SUBMIT_NAME: z.string(),
    SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_SUBMIT_URL: z.string(),
  }),
  STORAGE: z.object({
...
export const config = configSchema.parse({
  ...
  EVENTS: {
    SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_COMPLETE_NAME:
      process.env.SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_COMPLETE_NAME,
    SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_COMPLETE_URL:
      process.env.SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_COMPLETE_URL,
    SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_SUBMIT_NAME:
      process.env.SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_SUBMIT_NAME,
    SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_SUBMIT_URL:
      process.env.SQS_QUEUE_MEDIA_TRANSCODE_MEDIA_SUBMIT_URL,
  },
  STORAGE: {
