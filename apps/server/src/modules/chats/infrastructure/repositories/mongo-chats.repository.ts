...
import { IChatsRepository } from '@/modules/chats/domain/repositories';
import {
  MongoChat,
  MongoMessage,
  MongoUserChat,
...
export class MongoChatsRepository implements IChatsRepository {
  constructor(
    ...
    @InjectModel(MongoChat.name)
    private readonly _chatModel: Model<MongoChat>,
    @InjectModel(MongoMessage.name)
    private readonly _messageModel: Model<MongoMessage>,
    @InjectModel(MongoUserChat.name)
    private readonly _userChatModel: Model<MongoUserChat>,
    @InjectModel(MongoUserMessage.name)
    private readonly _userMessageModel: Model<MongoUserMessage>,
  ) {}
